...
const LedWord INFIX_BEFORE = LedWord(0, 3, 3); // VOR
const LedWord INFIX_AFTER = LedWord(7, 3, 4); // NACH
...
const LedWord MINUTE_QUARTER = LedWord(4, 2, 7); // VIERTEL
...
const LedWord WORD_FUNK = LedWord(3, 3, 4);
